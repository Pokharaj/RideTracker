...
public class RestControllerTest {
	...
	public void testGetRides() {
		...
		for (Ride ride : rides) {
			System.out.println("Ride: " + ride.getId() + " " + ride.getName());
		}
	}
	...
	public void testUpdateRide() {
		...
		Ride ride = restTemplate.getForObject("http://localhost:8080/ride_tracker/ride/4", Ride.class);

		ride.setName("Test Ride 4");
	...
	public void testException() {
		...
		restTemplate.getForObject("http://localhost:8080/ride_tracker/exception", Ride.class);
	}
}
